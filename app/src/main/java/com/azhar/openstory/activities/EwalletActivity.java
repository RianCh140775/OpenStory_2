...
//            }
        rv.addItemDecoration(new EwalletActivity.SimpleDividerItemDecoration(this));
    ...
    private void loadjson(LinearLayout root, String title, int startpos, int endpos) {
        try {
            ...
            InputStream in_s = res.openRawResource(R.raw.bldata2);
